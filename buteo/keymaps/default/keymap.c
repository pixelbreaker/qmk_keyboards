...
//// definitions
// layers
enum buteo_layers { _ALPHA, _NUM, _NAV, _SYM, _FUN };
// custom keycodes
enum custom_keycodes { COLEMAK = SAFE_RANGE, NUM, NAV, SYM, FUN, KC_MDOT };
...
combo_t key_combos[] = {[CAPSWORD_COMBO] = COMBO(capsword_combo, CW_TOGG),
